...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_TerrainMaterial = { "TerrainMaterial", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALandmassManagerWrapper, TerrainMaterial), Z_Construct_UClass_UMaterialInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TerrainMaterial_MetaData), NewProp_TerrainMaterial_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_NumOfChunksX = { "NumOfChunksX", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALandmassManagerWrapper, NumOfChunksX), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NumOfChunksX_MetaData), NewProp_NumOfChunksX_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_NumOfChunksY = { "NumOfChunksY", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALandmassManagerWrapper, NumOfChunksY), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NumOfChunksY_MetaData), NewProp_NumOfChunksY_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALandmassManagerWrapper_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_TerrainMaterial,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_NumOfChunksX,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_NumOfChunksY,
};
...
struct Z_CompiledInDeferFile_FID_Users_donut_Documents_LandmassGenerationUnreal_LandmassGeneration_Source_LandmassGeneration_Manager_LandmassManagerWrapper_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ALandmassManagerWrapper, ALandmassManagerWrapper::StaticClass, TEXT("ALandmassManagerWrapper"), &Z_Registration_Info_UClass_ALandmassManagerWrapper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALandmassManagerWrapper), 711289661U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_donut_Documents_LandmassGenerationUnreal_LandmassGeneration_Source_LandmassGeneration_Manager_LandmassManagerWrapper_h_453218950(TEXT("/Script/LandmassGeneration"),
