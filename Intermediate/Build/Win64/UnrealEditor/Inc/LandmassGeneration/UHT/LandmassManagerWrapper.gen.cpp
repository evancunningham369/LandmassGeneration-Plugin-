...
struct Z_Construct_UClass_ALandmassManagerWrapper_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_NumOfChunks_MetaData[] = {
		{ "Category", "LandmassManagerWrapper" },
		{ "ModuleRelativePath", "Manager/LandmassManagerWrapper.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFloatPropertyParams NewProp_NumOfChunks;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_NumOfChunks = { "NumOfChunks", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALandmassManagerWrapper, NumOfChunks), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NumOfChunks_MetaData), NewProp_NumOfChunks_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALandmassManagerWrapper_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALandmassManagerWrapper_Statics::NewProp_NumOfChunks,
};
...
struct Z_CompiledInDeferFile_FID_Users_donut_Documents_LandmassGenerationUnreal_LandmassGeneration_Source_LandmassGeneration_Manager_LandmassManagerWrapper_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ALandmassManagerWrapper, ALandmassManagerWrapper::StaticClass, TEXT("ALandmassManagerWrapper"), &Z_Registration_Info_UClass_ALandmassManagerWrapper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALandmassManagerWrapper), 3973588001U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_donut_Documents_LandmassGenerationUnreal_LandmassGeneration_Source_LandmassGeneration_Manager_LandmassManagerWrapper_h_3477453818(TEXT("/Script/LandmassGeneration"),
