...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T cs_6_6 -E MainCS -Fc LandmassComputeShader.d3dasm -Fo LandmassComputeShader.dxil LandmassComputeShader.usf
:END
PAUSE
